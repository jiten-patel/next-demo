        ...
        <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <Image src="/Stepozo.png" width={113} height={30} alt="stepozo" />
            </a>
          </div>
          <el-popover-group className="hidden lg:flex lg:gap-x-12">
            <a href="/" className="text-sm/6 font-semibold text-gray-900">Home</a>
            <a href="#" className="text-sm/6 font-semibold text-gray-900">Men</a>
            <a href="#" className="text-sm/6 font-semibold text-gray-900">Women</a>
            <a href="#" className="text-sm/6 font-semibold text-gray-900">Shop</a>
            <a href="#" className="text-sm/6 font-semibold text-gray-900">Pages</a>
          </el-popover-group>
